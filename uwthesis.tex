...
%
\Title{A Dielectrically-Loaded Fabry-Perot Open Resonator to Search for Higher-Mass Axionic Dark Matter}
\Author{Raphael Cervantes}
\Year{2021}
\Program{Physics}

\Chair{Gray Rybka}{Associate Professor}{Physics}
\Signature{Leslie Rosenberg}
\Signature{Jason Detweiler}
\Signature{etc}
...
% ----- dedication
%
\dedication{\begin{center}To my father Ruben Cervantes.\end{center}}
